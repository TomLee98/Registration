function volume = bfOpen3DVolume_reg(filename, wbar_flag)
% bfOpen3DVolume loads a stack of images using Bio-Formats and transforms them
% into a 3D volume
%
% SYNPOSIS  bfOpen3DVolume_reg
...
% replace bfopen with bfopen_reg for lower memory allocating and fast loading
volume = bfopen_reg(filename, wbar_flag);
end
